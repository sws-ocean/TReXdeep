...
%% CTD DATA
load('data20230707.mat', 'CTD1','CTD2')
...
m_contour(bathy.lon,bathy.lat,bathy.Z,[-50 -100 -150 -200 ],'color',[0.9 0.9 0.9]);
...
iax=axes('Position',[0.65 0.25 0.34 0.7]);
...
ax5=axes('position',[0.65+0.275 0.25 0.05 0.7]);
...
set(findall(gcf,'-property','fontname'),'fontname','Latin Modern Roman');
%% 
export_fig /Users/samst/Dropbox/UBC/TReX_paper/figures/letter/mapV6.pdf -dpdf -nofontswap